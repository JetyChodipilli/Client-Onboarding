...
export function PortalShell({ children }: { children: React.ReactNode }) {
  const [user, setUser] = useState<AuthUser>(); const [error, setError] = useState("");
  const { signOut, pending, error: logoutError } = useSignOut("/client/login");
